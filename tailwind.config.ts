  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        loboh: {
          navy: "hsl(var(--loboh-navy))",
          blue: "hsl(var(--loboh-blue))",
          "blue-light": "hsl(var(--loboh-blue-light))",
          "blue-dark": "hsl(var(--loboh-blue-dark))",
          cyan: "hsl(var(--loboh-cyan))",
          gray: {
